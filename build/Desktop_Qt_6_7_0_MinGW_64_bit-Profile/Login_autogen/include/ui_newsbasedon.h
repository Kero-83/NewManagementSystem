...
public:
    ...
    void retranslateUi(QMainWindow *Newsbasedon)
    {
        ...
        pushButton_Rate->setText(QCoreApplication::translate("Newsbasedon", "Rating", nullptr));
        pushButton_Category->setText(QCoreApplication::translate("Newsbasedon", "Category", nullptr));
        pushButton_Time->setText(QCoreApplication::translate("Newsbasedon", "Time", nullptr));
